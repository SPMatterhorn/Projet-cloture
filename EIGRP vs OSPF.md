...
Le ZBF Cisco nécessite de définir des zones de sécurité et de mettre en place des politiques de sécurité ciblées afin d'autoriser uniquement les flux de données nécessaires. Les politiques de sécurité sont à adapter suivant les topologies et les besoins (présence d'une dmz, ...).
...
|  |  |  |  | class-default |
| lan-dmz | lan | dmz | lan-dmz-policy | lan-dmz-class |
|  |  |  |  | class-default |
| internet-dmz | internet | dmz | internet-dmz-policy | internet-dmz-class |
|  |  |  |  | class-default |
| internet-self | internet | self | to-self-policy | remote-access-class |
|  |  |  |  | icmp-class |
|  |  |  |  | dhcp-class |
|  |  |  |  | dns-class |
|  |  |  |  | ntp-class |
|  |  |  |  | class-default |
| self-internet | self | internet | to-self-policy | remote-access-class |
|  |  |  |  | icmp-class |
|  |  |  |  | dhcp-class |
|  |  |  |  | dns-class |
|  |  |  |  | ntp-class |
